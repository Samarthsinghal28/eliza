...
-- Grant permissions if needed (uncomment and customize as necessary)
-- GRANT ALL PRIVILEGES ON TABLE traces TO eliza_user;

-- Sample query to find slow operations
-- SELECT 
--     span_name, 
